<html>
  ...
  <body>
    ...
    <h2 class="log-in-page">Update Vehicle</h2>
    ...
    <form id="register-form" action="UpdateVehicle" method="post">
      Tag: 
      	<select name="tag" id="tag">
      	<#list allVehicle as allVehicle>
      	<option>${allVehicle.getRegistrationTag()}</option>
      	</#list>
      	</select>
      ...
      <input type="text" name="Syear" placeholder="Year"><br>
